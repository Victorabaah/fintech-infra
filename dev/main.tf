...
module "eks" {
  ...
  security_group_ids = [module.eks_client_node.eks_client_sg]
...
module "eks_client_node" {
  ...
  vpc_id                 = module.vpc.vpc_id
  vpc_security_group_ids = [module.eks_client_node.eks_client_sg]
  cluster_name           = module.eks.cluster_name
  key_name               = module.eks_client_node.eks_client_private_key
...
module "jenkins_server" {
  ...
  main_region       = var.main_region
  security_group_id = module.eks_client_node.eks_client_sg
  subnet_id         = module.vpc.public_subnets[0]
}
